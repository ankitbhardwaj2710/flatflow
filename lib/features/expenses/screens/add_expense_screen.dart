  ...
  void _initializeMembers(List<Map<String, dynamic>> members) {
    ...
    if (widget.expense == null) {
      ...
      _selectedMemberIds.addAll(
        members.map((member) => member['id'] as String?).whereType<String>(),
      );
    }
    ...
    return Scaffold(
      ...
      body: membersAsync.when(
        ...
        error: (error, stackTrace) =>
            const Center(child: Text('Unable to load flat members.')),
        data: (members) {
          if (members.isEmpty) {
            return const Center(child: Text('No flat members found.'));
          }
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (_amount > 0 && _selectedMemberIds.isNotEmpty) ...[
...
class _SplitPreview extends StatelessWidget {
  ...
  const _SplitPreview({required this.amount, required this.memberCount});
