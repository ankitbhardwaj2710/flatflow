...
class PdfExportService {
  ...
  final pendingBills = bills.where((bill) => !bill.isPaid).toList();

  final pendingAmount = pendingBills.fold<double>(
    0,
  ...
  return [
    ...
    pw.Container(
      ...
      child: pw.Column(
        ...
        children: [
          pw.Text('Total Expenses : ₹${totalExpense.toStringAsFixed(2)}'),
